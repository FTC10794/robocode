...
//        colorSensor = (ModernRoboticsI2cColorSensor) hardwareMap.colorSensor.get(sensorName);
//
...
//        controller.registerForI2cPortReadyCallback(this, colorSensor.getPort());
//
//        // Unimportant.
...
//
//            String reading = "R(" + colorSensor.red() +
//                    ") G(" + colorSensor.green() +
//                    ") B(" + colorSensor.blue() +
//                    ") A(" + colorSensor.alpha() + ")";
//
